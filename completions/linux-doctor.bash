...
_linux_doctor() {
  ...
  if [[ "$cur" == -* ]]; then
    COMPREPLY=($(compgen -W "--check --ignore --ignore-code --ignore-add --ignore-remove --push --html --severity --compare --alert --interval --json --plain --web --ai --list --schema --profile --ignore-list --summary --init-config --check-list --history-json --history-clear --thresholds-json --thresholds-set --todo --fix --yes --interactive --notify --self-test --license --daemon --support --no-history --help --version" -- "$cur"))
  fi
}
